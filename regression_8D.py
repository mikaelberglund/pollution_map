...
x_train, x_test, y_train, y_test = model_selection.\
    train_test_split(x_train, y_train, test_size=.15)
...
#TODO: Kolla varför vissa punkter beräknas korrekt men inte andra?
#TODO: Är vissa dimensioner i "bilderna" inte relevanta?
